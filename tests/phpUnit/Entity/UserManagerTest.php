...
class UserManagerTest extends TestCase
{
  ...
  protected function setUp(): void
  {
    ...
    $program_maner = $this->createMock(ProgramManager::class);
    $this->user_manager = new UserManager($passwordUpdater, $canonicalFieldsUpdater, $object_manager, $program_maner);
  }
