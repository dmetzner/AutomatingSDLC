...
////////////////////////////////////////////// Getter & Setter
  ...
  public function iHaveAProject($project_zip_name)
  {
    ...
    $original_file = self::FIXTUREDIR . $project_zip_name;
  ...
  {
    $this->symfony_support->upload(sys_get_temp_dir() . '/program_generated.catrobat', null, $id);
  }
   ...
   * @throws Exception
   */
  public function allCatroidBlocksTheyShouldAlsoBeImplementedInCatroweb()
  {
    ...
    if (count($diff_result_not_in_web_but_app) > 0 || count($diff_result_not_in_app_but_web) > 0)
    {
      ...
      $message .= count($diff_result_not_in_web_but_app) > 0 ?
        ...
        "//" . "\n" .
        "// Now should not only this test case work, the new block is implemented and tests in catroweb" . "\n" .
        "//" . "\n\n" : "";
