...
class ApiContext implements KernelAwareContext
{
  ...
  public function responseShouldContainTheFollowingProjects(TableNode $table): void
  {
    ...
    $this->checkReturnedPrograms($returned_programs, $expected_programs);
  }
  ...
  public function responseShouldContainMediaFilesInTheFollowingOrder(TableNode $table): void
  {
    ...
    Assert::assertEquals(count($returned_files), count($expected_files),
      'Number of returned programs should be '.count($returned_files));
  ...
  private function checkReturnedPrograms(array $returned_programs, array $expected_programs): void
  {
    Assert::assertEquals(count($returned_programs), count($expected_programs), 'Number of returned programs should be '.count($returned_programs));
