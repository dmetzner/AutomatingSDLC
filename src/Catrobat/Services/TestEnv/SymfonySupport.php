...
trait SymfonySupport
{
   ...
   * @var string
   */
  public $ERROR_DIR = 'tests/testreports/behat/';

  /**
   * @var string
   */
  public $FIXTURES_DIR = './tests/testdata/DataFixtures/';

  /**
   * @var string
   */
  public $SCREENSHOT_DIR = 'tests/testreports/screens/';
   ...
   * @var string
   */
  public $EXTRACT_RESOURCES_DIR = './public/resources_test/extract/';
